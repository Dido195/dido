...
helpMessage ="""    •─ ✫-[✭]─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─[✭]- ✫─•
🍖 คำสั่ง ➠ ดูคำสั่ง
💖 คำสั่ง2 ➠ ดูคำสั่ง2
💕 ทักเข้า ➠ เช็คข้อความทักเข้า
🍖 ทักออก ➠ เช็คข้อความทักออก
💖 ทักลบ ➠ เช็คข้อความทักคนลบ
💕 ทัก เข้า: +ข้อความ ➠ ตั้งทักเข้า
🍖 ทัก ออก: +ข้อความ ➠ ตั้งทักคนออก
💖 ทัก ลบ: +ข้อความ ➠ ตั้งทักคนลบ
...
💖 ชื่อ เรา: +ข้อความ ➠ เปลี่ยนชื่อเรา
💕 1-6ชื่อ: +ข้อความ ➠ เปลี่ยนชื่อคลิ้ก
🍖 ตัส เรา: +ข้อความ ➠ เปลี่ยนตัสเรา
💖 บอท ➠ คทคลิ้ก
...
🍖 T L:  ➠ โพส
    •─ ✫-[✭] ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─[✭]- ✫─•
**ทุกคำสั่งไม่ต้องเว้นวรรค ที่เขียนเว้นเพื่อไม่ให้คำสั่งทำงาน**
"""
helpMessage2 ="""🍖 .11 ➠ 
💖 T say  ➠ 
💕 Me ban ➠ 
...
wait = {
    ...
    'message':"─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─",
    "lang":"JP",
    "comment":"AutoLike by─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
...
def bot(op):
    try:
        ...
        if op.type == 13:
            ...
            cl.acceptGroupInvitationByTicket(op.param1,Ticket)
            G.preventJoinByTicket = False
            cl.sendText(op.param1,"By . ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
        ...
        if op.type == 17:
            if op.param2 not in Bots:
                ...
                if wait["protect"] == True:
                    ...
                    random.choice(KAC).sendText(op.param1,"By. ༺ ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─ ༻")
                else:
                    pass
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                if wait["kickMention"] == True:
                    ...
                    balas = ["จุกไมละมึง By.  ༺ ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─ ༻" + cName]
...
#======================================================#
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"By. ༺ ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─ ༻")
                else:
                    wait["contact"] = False
                    if wait["lang"] == "JP":
...
#======================================================#
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เปิดระบบกัน By.─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                    else:
...
#======================================================#
                ...
                profile = ki.getProfile()
                text = profile.displayName + " ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─"
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,"Bye Bye "  +  str(ginfo.name)  + "By. ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
...
#                gid = cl.getGroupIdsJoined()
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"ลิ้งค์ของกลุ่ม By. ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                ...
                if wait["clock"] == True:
                    ...
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"เแิดชื่อ+เวลาเรียบร้อย by.─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                ...
                if wait["lang"] == "JP":
                    ...
                    ki.sendText(msg.to,"By. ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                ...
                if wait["lang"] == "JP":
                    ...
                    ki2.sendText(msg.to,"By. ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                ...
                if wait["lang"] == "JP":
                    ...
                    ki3.sendText(msg.to,"By. ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                ...
                if wait["lang"] == "JP":
                    ...
                    ki4.sendText(msg.to,"By.─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                ...
                if wait["lang"] == "JP":
                    ...
                    ki5.sendText(msg.to,"By. ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                ...
                if wait["lang"] == "JP":
                   ki6.sendText(msg.to,"ลบห้องเชิญเรียบร้อยแล้ว\nBy.─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
                    ...
                    ki6.sendText(msg.to,"By. ─┅═ह쇼ஞิɔ∫ஞ้쇼ह═┅─")
